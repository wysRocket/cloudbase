...
VALUES
  ...
  ('do-k8s-basic-3node-nyc3', 'kubernetes', 'DigitalOcean', 'do-k8s-basic-3node', 'nyc3', 36.00, 36.00, 'monthly', '{"nodes":"3","cpu":"2vCPU per node","ram":"4GB per node"}', 0, true),
  ('do-k8s-basic-3node-sfo3', 'kubernetes', 'DigitalOcean', 'do-k8s-basic-3node', 'sfo3', 36.00, 36.00, 'monthly', '{"nodes":"3","cpu":"2vCPU per node","ram":"4GB per node"}', 0, true),
  ('do-k8s-basic-3node-fra1', 'kubernetes', 'DigitalOcean', 'do-k8s-basic-3node', 'fra1', 36.00, 36.00, 'monthly', '{"nodes":"3","cpu":"2vCPU per node","ram":"4GB per node"}', 0, true),
  ('do-k8s-basic-3node-lon1', 'kubernetes', 'DigitalOcean', 'do-k8s-basic-3node', 'lon1', 36.00, 36.00, 'monthly', '{"nodes":"3","cpu":"2vCPU per node","ram":"4GB per node"}', 0, true),
  ('do-k8s-basic-3node-sgp1', 'kubernetes', 'DigitalOcean', 'do-k8s-basic-3node', 'sgp1', 36.00, 36.00, 'monthly', '{"nodes":"3","cpu":"2vCPU per node","ram":"4GB per node"}', 0, true),
  ...
  -- GPU H100 (2 regions)
  ('do-gpu-h100-1x-nyc3', 'gpu', 'DigitalOcean', 'do-gpu-h100-1x', 'nyc3', 2.50, 2.50, 'hourly', '{"gpu":"NVIDIA H100","vram":"80GB HBM3"}', 0, true),
  ('do-gpu-h100-1x-fra1', 'gpu', 'DigitalOcean', 'do-gpu-h100-1x', 'fra1', 2.50, 2.50, 'hourly', '{"gpu":"NVIDIA H100","vram":"80GB HBM3"}', 0, true),
