...
alter table public.provisioning_quotas enable row level security;
alter table public.provisioning_quotas force row level security;
alter table public.provisioning_rate_limits enable row level security;
alter table public.provisioning_rate_limits force row level security;

revoke all on public.provisioning_quotas from anon;
revoke all on public.provisioning_quotas from authenticated;
revoke all on public.provisioning_rate_limits from anon;
revoke all on public.provisioning_rate_limits from authenticated;
grant select, insert, update on public.provisioning_quotas to service_role;
grant select, insert, update on public.provisioning_rate_limits to service_role;
