...
const LOGS = [
	...
	{
		type: "info",
		msg: "Pulling Docker image: registry.cloudbase.io/app:latest",
	},
	{ type: "success", msg: "Image pulled (842MB) in 1.4s" },
	{ type: "info", msg: "Starting health checks..." },
	{ type: "success", msg: "Application is LIVE at app-7a8f.cloudbase.net" },
	...
	return (
		<div className="bg-black/80 rounded-2xl border border-white/10 p-6 font-mono text-sm h-full flex flex-col shadow-2xl overflow-hidden relative group">
			...
			<div className="flex gap-2 mb-4">
				...
				<span className="text-[10px] text-slate-600 ml-2 uppercase tracking-widest">
					deployment-live-log
				</span>
			</div>
