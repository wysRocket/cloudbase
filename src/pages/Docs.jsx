				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-slate-400 max-w-2xl">
							Everything you need to build and scale on Cloudbase.
						</p>
					</motion.div>
				</div>
			</section>
										...
										{activeArticle.content.split("\n").map((line, i) => {
											...
											if (line.startsWith("### "))
												return (
													<h3
														key={i}
														className="text-xl font-bold text-white mb-3 mt-6"
													>
														{line.replace("### ", "")}
													</h3>
												);
			...
			<section className="py-16 px-6 bg-white/5">
				<div className="max-w-3xl mx-auto text-center">
					...
					<div className="flex gap-4 justify-center flex-wrap">
						<Link
							to="/support"
							className="px-6 py-3 bg-cyan-600 hover:bg-cyan-500 rounded-full font-bold transition-all shadow-lg shadow-cyan-500/20"
						>
