...
export default function SignUpPage() {
	...
	const handleOAuth = async (provider) => {
		...
		if (err)
			setOauthError(err.message || `Unable to sign up with ${provider}.`);
	};
		...
		<section className="min-h-screen flex">
				...
				<div className="w-full max-w-md">
					<div className="w-full rounded-2xl bg-slate-100 border border-slate-200 p-6">
						...
						<p className="text-sm text-slate-600 mt-1">
							Launch your cloud workspace in minutes.
						</p>
						...
						<p className="mt-4 text-sm text-slate-600">
							...
							<Link to="/sign-in" className="text-cyan-600 hover:text-cyan-700">
								Sign in
							</Link>
						</p>
					</div>
			...
			<div className="hidden lg:flex flex-1 text-white flex-col justify-center items-center p-12 relative overflow-hidden">
				...
				<div className="relative z-10 max-w-lg text-center">
					...
					<h2 className="text-3xl font-bold mb-4">Start Your Cloud Journey</h2>
					<p className="text-lg text-white/80 mb-8">
						Create your free account and get €100 in credits. Deploy VPS,
						Kubernetes clusters, and GPU servers in minutes with our intuitive
						platform.
					</p>
