					...
					<div className="prose prose-invert prose-lg max-w-none space-y-8">
						...
						<section>
							...
							<p className="text-slate-300 leading-relaxed">
								By accessing or using Cloudbase services, you agree to be bound
						...
						<section>
							...
							<p className="text-slate-300 leading-relaxed">
								Services are billed monthly in advance. You authorize us to
								charge your payment method on file. All fees are non-refundable
								except as required by law or as specifically stated otherwise.
							</p>
						</section>
