					...
					<div className="prose prose-invert prose-lg max-w-none space-y-8">
						...
						<section>
							...
							<ul className="list-disc list-inside text-slate-300 space-y-2">
								...
								<li>Refrain from using the services for illegal, malicious, fraudulent, or abusive activities, including phishing, malware distribution, credential stuffing, DDoS attacks, crypto-mining where prohibited, sanctions evasion, or unauthorized access to systems/data.</li>
						...
						<section>
							...
							<p className="text-slate-300 leading-relaxed mb-4">
								If you resell Cloudbase services to your own customers, you remain fully responsible for your downstream users, including contracting, support, and legal compliance.
							</p>
							<ul className="list-disc list-inside text-slate-300 space-y-2">
								<li>Ensure your customers receive terms, privacy notices, and acceptable use rules at least as strict as ours.</li>
								<li>Act as first-line support for your customers unless otherwise agreed in writing.</li>
								<li>Promptly respond to abuse reports and cooperate with Cloudbase investigations and remediation requests.</li>
								<li>You are financially liable for all usage and charges generated by your reseller account and sub-accounts.</li>
							</ul>
						</section>
