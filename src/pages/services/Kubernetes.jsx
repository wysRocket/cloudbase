				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-slate-400 max-w-2xl mb-10">
							Managed Kubernetes clusters that scale with your applications.
							Deploy, manage, and scale containerized workloads with ease.
						</p>
						...
						{[
							{
								...
								desc: "We handle the Kubernetes control plane, you focus on your apps",
								icon: "🎛️",
							},
							{
								title: "Auto-scaling",
								desc: "Automatically scale pods based on demand",
								icon: "📈",
							},
							{
								title: "Load Balancing",
								desc: "Built-in load balancers for your services",
								icon: "⚖️",
							},
							{
								title: "Private Registry",
								desc: "Secure container registry included",
								icon: "📦",
							},
							{
								title: "Monitoring",
								desc: "Full observability with metrics and logs",
								icon: "📊",
							},
							{
								title: "CI/CD Ready",
								desc: "Integrate with your deployment pipelines",
								icon: "🔄",
							},
						].map((f, i) => (
							<div
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							...
							>
								{plan.popular && (
									<div className="text-xs bg-cyan-500 text-black px-3 py-1 rounded-full uppercase font-bold inline-block mb-4">
										Popular
									</div>
								)}
