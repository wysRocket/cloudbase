...
export default function VPS() {
	...
	return (
		<>
				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-slate-400 max-w-2xl mb-10">
							High-performance NVMe SSD storage, lightning-fast network, and
							99.9% uptime SLA. Deploy your server in under 60 seconds.
						</p>
						<div className="flex gap-4 flex-wrap">
							<Link
								to="/dashboard"
								className="px-8 py-4 bg-cyan-600 hover:bg-cyan-500 rounded-full font-bold transition-all"
							>
								Deploy Now
							</Link>
							<Link
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							{
								title: "NVMe Storage",
								desc: "Blazing fast storage for your applications",
								icon: "⚡",
							},
							{
								title: "Global Network",
								desc: "15+ data center locations worldwide",
								icon: "🌍",
							},
							{
								title: "Dedicated Resources",
								desc: "KVM virtualization ensures guaranteed performance",
								icon: "🔒",
							},
							{
								title: "Root Access",
								desc: "Full control over your server environment",
								icon: "🛠️",
							},
							{
								title: "DDoS Protection",
								desc: "Enterprise-grade security included",
								icon: "🛡️",
							},
							{
								title: "Instant Scaling",
								desc: "Upgrade resources with a single click",
								icon: "📈",
							},
						].map((f, i) => (
							<div
			...
			{/* Plans Table */}
			<motion.section {...fadeInUp} className="py-20 px-6 max-w-7xl mx-auto">
				<div className="glass rounded-[2rem] overflow-hidden border-white/5">
					<div className="overflow-x-auto">
						<table className="w-full text-left border-collapse">
							<thead>
								<tr className="border-b border-white/10 bg-white/5">
									<th className="p-6 font-bold uppercase text-xs tracking-widest text-slate-500">
										Plan
									</th>
									<th className="p-6 font-bold uppercase text-xs tracking-widest text-slate-500">
										RAM
								...
								{plans.map((plan, i) => (
									...
									>
										...
										<td className="p-6">
											<Link
												to="/contact"
												className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 rounded-lg text-sm font-bold transition-all"
											>
												Deploy
											</Link>
										</td>
