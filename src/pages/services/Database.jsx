				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-slate-400 max-w-2xl mb-10">
							Secure, scalable database solutions. PostgreSQL, MySQL, Redis, and
							MongoDB — fully managed with automatic backups and high
							availability.
						</p>
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
						{[
							...
							{
								name: "Redis",
								desc: "In-memory data store for caching",
								icon: "⚡",
							...
							<div
								key={i}
								className={`glass p-8 rounded-2xl bg-gradient-to-br ${db.color} to-transparent hover:scale-105 transition-transform`}
							>
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								desc: "Automatic failover with standby replicas",
								icon: "🔄",
							},
							{
								title: "Encryption",
							...
							{
								title: "Scaling",
								desc: "Easily scale storage and compute",
								icon: "📈",
							},
							{
								title: "Monitoring",
							...
							},
							{
								...
								desc: "Built-in connection management",
								icon: "🔗",
							},
						].map((f, i) => (
							<div
