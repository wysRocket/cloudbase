				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-slate-400 max-w-2xl mb-10">
							NVIDIA-powered computing for machine learning, deep learning, and
							AI training. Rent computational power, not just hardware.
						</p>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						{gpus.map((gpu, i) => (
							...
							>
								...
								<Link
									to="/contact"
									className="w-full py-3 glass rounded-xl font-bold text-center block hover:bg-white/10"
								>
									Request Access
								</Link>
							</div>
			...
			>
				<div className="max-w-3xl mx-auto text-center">
					<h2 className="text-4xl font-bold mb-6">
						Need Custom GPU Configuration?
					</h2>
					<p className="text-slate-400 mb-8">
						Our team can help you design the perfect GPU cluster for your
						workload.
					</p>
					<Link
						to="/contact"
