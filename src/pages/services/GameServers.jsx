				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-xl text-slate-400 max-w-2xl mb-10">
							Premium game server hosting with instant deployment. Minecraft,
							Rust, CS2, and more — optimized for gaming with DDoS protection
							included.
						</p>
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid md:grid-cols-4 gap-6">
						{[
							...
							{
								title: "Instant Setup",
								desc: "Server ready in 60 seconds",
								icon: "⚡",
							},
							{
								title: "Mod Support",
								desc: "Easy mod installation",
								icon: "🔧",
							},
							{
								title: "Auto Backups",
								desc: "Never lose your world",
								icon: "💾",
							},
							{
								title: "Global Locations",
								desc: "15+ datacenter regions",
								icon: "🌍",
							},
			...
			>
				<div className="max-w-3xl mx-auto text-center">
					...
					<p className="text-slate-400 mb-8">
						We support 100+ games. Contact us for custom configurations.
					</p>
					<Link
						to="/contact"
