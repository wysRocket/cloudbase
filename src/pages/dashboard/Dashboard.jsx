        ...
        <>
            ...
            <div className="flex justify-between items-end mb-10">
                <div>
                    ...
                    <p className="text-slate-400">Welcome back, here's what's happening with your infrastructure.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                {stats.map((stat, i) => (
                    ...
                    >
                        <h3 className="text-slate-400 text-sm font-medium mb-4">{stat.title}</h3>
                        <div className="flex items-end justify-between">
                            <div className="text-2xl font-bold">{stat.value}</div>
                            <div className={`text-xs px-2 py-1 rounded-full ${stat.trend === 'up' ? 'bg-cyan-500/10 text-cyan-400' :
