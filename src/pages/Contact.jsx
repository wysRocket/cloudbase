	...
	return (
		<>
			...
			<section className="relative pt-32 pb-20 px-6">
				...
				<div
					className="aurora-blob w-[600px] h-[600px] bg-blue-500/10 bottom-0 right-0 animate-aurora"
					...
					<div className="grid lg:grid-cols-2 gap-16 items-start">
						...
						>
							...
							<p className="text-xl text-slate-400 mb-12 max-w-lg">
								Ready to scale your infrastructure? Our team will help you find
						...
						>
							{submitted ? (
								...
								<form
									...
									className="glass p-8 rounded-[2rem] space-y-5"
								>
									<div>
									...
									<div>
										...
										<div className="relative">
											...
											>
												...
												>
													{cloudSpendOptions.find(
														(opt) => opt.value === formData.cloudSpend,
														...
														{cloudSpendOptions.map((option) => (
															<button
																...
																className={`w-full px-4 py-3 text-left hover:bg-white/10 transition-colors ${
																	formData.cloudSpend === option.value
