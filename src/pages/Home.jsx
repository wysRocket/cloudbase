        ...
        <>
            ...
            <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    {/* GPU Card */}
                    <Link to="/services/gpu" className="md:col-span-4 glass p-10 rounded-[3rem] bg-gradient-to-br from-cyan-600/20 to-blue-900/40 border-cyan-500/30 block">
                    ...
                    {/* Kubernetes Card */}
                    <Link to="/services/kubernetes" className="md:col-span-4 glass p-10 rounded-[3rem] flex flex-col justify-between block">
                        <div>
                    ...
                    {/* Game Servers */}
                    <Link to="/services/game-servers" className="md:col-span-8 glass p-10 rounded-[3rem] flex items-center gap-8 group block">
                        ...
                        <div className="w-32 h-32 glass rounded-2xl flex items-center justify-center shrink-0 group-hover:rotate-12 transition-transform">
            ...
            <section id="overview" className="py-24 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
                <div className="sticky top-32 h-fit">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-6 glass rounded-2xl border-l-4 border-white/5 opacity-40 hover:opacity-100 transition-opacity">
                ...
                <div className="space-y-12">
                    ...
                    <div className="p-12 glass rounded-[3rem] bg-black">
            ...
            <section id="pricing" className="py-32 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Basic */}
                        <div className="glass p-12 rounded-[3rem] border-white/5 flex flex-col hover:scale-105 transition-transform duration-500">
            ...
            <section className="py-32 max-w-5xl mx-auto px-6">
                <div className="space-y-24">
                    ...
                    <div className="sticky top-28 glass p-12 rounded-[3rem] shadow-2xl bg-[#111a31] border-cyan-500/20 h-[400px] flex flex-col justify-center translate-y-4">
                        <span className="text-cyan-400 font-mono mb-4">PHASE 02</span>
                    ...
                    <div className="sticky top-32 glass p-12 rounded-[3rem] shadow-2xl bg-[#15203d] border-cyan-500/20 h-[400px] flex flex-col justify-center translate-y-8">
                        <span className="text-cyan-400 font-mono mb-4">PHASE 03</span>
