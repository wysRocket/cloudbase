...
const initialNotifications = [
	{
		...
		message: "Your account is ready. Deploy your first service to get started.",
		time: "2 hours ago",
		read: false,
	},
	{
		...
		message:
			"Planned maintenance on Feb 20, 2026 at 03:00 UTC. Expect up to 15 minutes of downtime.",
		time: "1 day ago",
		read: false,
	},
	{
		...
		message:
			"Your Pro Plan subscription is now active. Enjoy 2900 credits/month.",
		time: "3 days ago",
		read: true,
	},
];
		...
		<DashboardProvider>
			<div className="bg-[#0a0f1d] min-h-screen text-slate-100 font-sans selection:bg-cyan-500 selection:text-white">
				<div className="flex h-screen overflow-hidden">
					...
					{/* Main Content Area */}
					<main
						className={`flex-1 overflow-y-auto transition-all duration-300 ${isSidebarOpen ? "md:ml-64" : "md:ml-64"} ml-0 relative`}
					>
						{/* Header/Top Bar */}
													...
													>
														<div className="flex items-start gap-3">
															...
															<div className={!notif.read ? "" : "ml-5"}>
																<p
																	className={`text-sm font-medium ${!notif.read ? "text-white" : "text-slate-300"}`}
																>
																	{notif.title}
																</p>
